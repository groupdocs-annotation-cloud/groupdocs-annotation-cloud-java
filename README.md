...
dependencies {
    ...
    implementation 'com.groupdocs:groupdocs-annotation-cloud:23.12'
}
```
...
* Build and execute
* Explore more samples at [GitHub](https://github.com/groupdocs-annotation-cloud/groupdocs-annotation-cloud-java-samples)
...
* target/groupdocs-annotation-cloud-23.12.jar
* target/lib/*.jar
